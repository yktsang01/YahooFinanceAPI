...
public class HistQuotesRequest {
    ...
    public List<HistoricalQuote> getResult() throws IOException {
        ...
        Map<String, String> requestProperties = new java.util.HashMap<String, String>(); //added to work
        requestProperties.put("User-Agent", "Mozilla/5.0 *"); //added to work
        URLConnection connection = redirectableRequest.openConnection(requestProperties); // added to work
//        URLConnection connection = redirectableRequest.openConnection(); // commented
